...
const propertyFilterSlice = createSlice({
  ...
  reducers: {
    setSearch: (state, action) => {
      ...
      state.activeFilters = getActiveFilters({ ...state, search: action.payload });
    },
    setPriceRange: (state, action) => {
      state.priceRange = action.payload;
      state.activeFilters = getActiveFilters({ ...state, priceRange: action.payload });
    },
    setRating: (state, action) => {
      state.rating = action.payload;
      state.activeFilters = getActiveFilters({ ...state, rating: action.payload });
    },
    setBedrooms: (state, action) => {
      state.bedrooms = action.payload;
      state.activeFilters = getActiveFilters({ ...state, bedrooms: action.payload });
    },
    setBathrooms: (state, action) => {
      state.bathrooms = action.payload;
      state.activeFilters = getActiveFilters({ ...state, bathrooms: action.payload });
    },
    setHasKitchen: (state, action) => {
      state.hasKitchen = action.payload;
      state.activeFilters = getActiveFilters({ ...state, hasKitchen: action.payload });
    },
    setSortOption: (state, action) => {
      state.sortOption = action.payload;
      state.activeFilters = getActiveFilters({ ...state, sortOption: action.payload });
    },
    resetFilters: (state) => {
...
function getActiveFilters(state) {
  ...
  if (state.sortOption !== 'latest') activeFilters.sortOption = state.sortOption;
